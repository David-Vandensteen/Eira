...
:compile-program
gcc -I%NEODEV%\m68k\include -m68000 -O3 -Wall -fomit-frame-pointer -ffast-math -fno-builtin -nostartfiles -nodefaultlibs -D__cd__ -c main.c -o %buildTemp%\main.o 2>%buildErrLog%
gcc -I%NEODEV%\m68k\include -m68000 -O3 -Wall -fomit-frame-pointer -ffast-math -fno-builtin -nostartfiles -nodefaultlibs -D__cd__ -c neo_core.c -o %buildTemp%\neo_core.o 2>>%buildErrLog%
gcc -I%NEODEV%\m68k\include -m68000 -O3 -Wall -fomit-frame-pointer -ffast-math -fno-builtin -nostartfiles -nodefaultlibs -D__cd__ -c neo_db.c -o %buildTemp%\neo_db.o 2>>%buildErrLog%
gcc -I%NEODEV%\m68k\include -m68000 -O3 -Wall -fomit-frame-pointer -ffast-math -fno-builtin -nostartfiles -nodefaultlibs -D__cd__ -c logoEffect.c -o %buildTemp%\logoEffect.o 2>>%buildErrLog%
gcc -I%NEODEV%\m68k\include -m68000 -O3 -Wall -fomit-frame-pointer -ffast-math -fno-builtin -nostartfiles -nodefaultlibs -D__cd__ -c neo_texter.c -o %buildTemp%\neo_texter.o 2>>%buildErrLog%
gcc -I%NEODEV%\m68k\include -m68000 -O3 -Wall -fomit-frame-pointer -ffast-math -fno-builtin -nostartfiles -nodefaultlibs -D__cd__ -c snowfield.c -o %buildTemp%\snowfield.o 2>>%buildErrLog%
gcc -I%NEODEV%\m68k\include -m68000 -O3 -Wall -fomit-frame-pointer -ffast-math -fno-builtin -nostartfiles -nodefaultlibs -D__cd__ -c triangles.c -o %buildTemp%\triangles.o 2>>%buildErrLog%
gcc -I%NEODEV%\m68k\include -m68000 -O3 -Wall -fomit-frame-pointer -ffast-math -fno-builtin -nostartfiles -nodefaultlibs -D__cd__ -c backdropcolor.c -o %buildTemp%\backdropcolor.o 2>>%buildErrLog%
...
set gfxObjectList=%buildTemp%\triangle03down.o %buildTemp%\triangle02down.o %buildTemp%\triangle02up.o %buildTemp%\triangle03up.o %buildTemp%\triangle01down.o %buildTemp%\triangle01up.o %buildTemp%\snow.o
set gfxObjectList=%gfxObjectList% %buildTemp%\logo_76.o %buildTemp%\logo_75.o %buildTemp%\logo_74.o %buildTemp%\logo_73.o %buildTemp%\logo_72.o %buildTemp%\logo_71.o %buildTemp%\logo_70.o %buildTemp%\logo_69.o %buildTemp%\logo_68.o %buildTemp%\logo_67.o %buildTemp%\logo_66.o %buildTemp%\logo_65.o %buildTemp%\logo_64.o %buildTemp%\logo_63.o %buildTemp%\logo_62.o %buildTemp%\logo_61.o %buildTemp%\logo_60.o %buildTemp%\logo_59.o %buildTemp%\logo_58.o %buildTemp%\logo_57.o %buildTemp%\logo_56.o %buildTemp%\logo_55.o %buildTemp%\logo_54.o %buildTemp%\logo_53.o %buildTemp%\logo_52.o %buildTemp%\logo_51.o %buildTemp%\logo_50.o
...
:link
gcc -L%NEODEV%\m68k\lib -m68000 -O3 -Wall -fomit-frame-pointer -ffast-math -fno-builtin -nostartfiles -nodefaultlibs -D__cd__ -Wl,-T%NEODEV%\src\system\neocd.x %buildTemp%\crt0_cd.o %buildTemp%\main.o %buildTemp%\neo_core.o %buildTemp%\neo_db.o %buildTemp%\logoEffect.o %buildTemp%\neo_texter.o %buildTemp%\snowfield.o %buildTemp%\palettes.o %buildTemp%\triangles.o %buildTemp%\backdropcolor.o %gfxObjectList% -lcddactrl -lmath -linput -lvideo -lc -lgcc -o %buildTemp%\DEMO.o
